...
ActiveRecord::Schema.define(version: 20_180_929_204_602) do
  ...
  create_table 'movie_roles', force: :cascade do |t|
    ...
    t.index ['movie_id'], name: 'index_movie_roles_on_movie_id', using: :btree
    t.index ['person_id'], name: 'index_movie_roles_on_person_id', using: :btree
  end
